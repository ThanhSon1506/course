...
@Component({
  selector: 'app-table-list-student',
  templateUrl: './table-list-student.component.html',
  styleUrls: ['./table-list-student.component.scss']
})
export class TableListStudentComponent implements AfterViewInit {
  ...
  selectedData:any;
  listStudent:any;
  displayedColumns: string[] =['id','name','lastname','firstname','phone','price'];
